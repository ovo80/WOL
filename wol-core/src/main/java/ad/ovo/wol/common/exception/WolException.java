 ...
 */
package ad.ovo.wol.common.exception;

/**
 * 业务异常：消息面向最终用户，可直接展示在界面状态区。
 *
 * <p>使用约定：Service 层将底层异常（{@link IllegalArgumentException}、{@link java.io.IOException}）转译为本类型后抛出，
 * Controller 捕获后直接展示 {@link #getMessage()}，不附加技术细节。
 */
