...
class WolUtilTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {"00:1A:2B:3C:4D", "GG:1A:2B:3C:4D:5E", "", "00:1A:2B:3C:4D:5",
    ...
    void buildMagicPacket_结构应为6个FF加16次MAC共102字节() {
        ...
        for (int r = 0; r < 16; r++) {
            assertArrayEquals(mac, Arrays.copyOfRange(pkt, 6 + r * 6, 12 + r * 6),
                    "第 " + r + " 次重复的 MAC 内容应一致");
        }
    }
